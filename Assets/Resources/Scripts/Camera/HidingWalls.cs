...
{
	/* Provided by GameVortex 
	 * on https://answers.unity.com/questions/343581/how-to-achieve-diablo-style-walls.html */
	...
	void Update()
	{
		...
		Vector3 direction = player.position - _camera.position;
		...
		RaycastHit[] hits = Physics.RaycastAll(_camera.position, direction, distance, layerMask);
